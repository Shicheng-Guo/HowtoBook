...
Summary: 10 multi-hits SNPs and [82 unique SNP](RA-GWAS-Functional-SNPs-Final.82.Snp.20190208.bed) and [55 genomic regions](RA-GWAS-Functional-SNPs-Final.82.Snp.20190208.sort.merge.hg19.bed) were occured in the final SNPs list. 
